...
var aliases = {
  ...
  cleric: {
    ...
    // Buff
    "благ": "колдовать эблагоэ",

    // Harms
    "свред": "колдовать эсерьезный вредэ",
    "лвред": "колдовать элегкий вредэ",

    // Aux
    "свод": "колдовать эсоздать водуэ",
    "спищ": "колдовать эсоздать пищуэ"
  },
  mage: {
    // Damage
    ...
    "мим": "колдовать эмагический импульсэ",

    // Buff
    "флай": "колдовать эполетэ",
    "затум": "колдовать эзатуманиваниеэ",

    // Aux
    "свет": "колдовать эсоздать светэ;держать факел",
    "инфра": "колдовать эинфракрасное зрение",
    "вимаг": "колдовать эвидеть магиюэ",
    "винев": "колдовать эвидеть магиюэ"
  },
  archer: {
    "укл": "уклониться",
    "вее": "веерный",
